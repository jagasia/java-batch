...
public class PassportApplyDAOImpl implements PassportApplyDAO{
	...
	public PassportApply read(String id) throws SQLException, ParseException {
		Connection con=MyConnection.getConnection();
		PreparedStatement ps = con.prepareStatement("SELECT * FROM PASSPORTAPPLY WHERE APPLICATION_ID=?");
		ps.setString(1,id);
	...
	public static void main(String[] args) throws ParseException, SQLException {
		...
		PassportApply passportclass = new PassportApply("A012345681", "Vamsi", "Balasa",sdf.parse("18-JUN-98") , "Guntur", 7896272982l,  123456789098l , "G1 Venkatramnagar", "Indian", "Telangana", "Hyderabad");
